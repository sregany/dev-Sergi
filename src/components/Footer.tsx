...
const Footer = () => {
  return (
    <footer id="contact" className="pt-20 md:pt-32 pb-12 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        {/* CTA Section */}
        <div className="relative glass p-6 sm:p-12 md:p-24 rounded-3xl md:rounded-[3rem] border-white/5 overflow-hidden text-center mb-16 md:mb-24">
          {/* Background Glow */}
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h4 className="text-brand-cyan font-display mb-4 md:mb-6 uppercase tracking-[0.4em] text-xs font-bold">Get in touch</h4>
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-display mb-8 md:mb-12 leading-tight">
              Let's build <br />
