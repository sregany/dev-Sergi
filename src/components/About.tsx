        ...
        >
          ...
          <div className="relative bg-[#050505] border border-white/10 rounded-xl overflow-hidden shadow-2xl">
            <div className="flex items-center gap-1.5 p-3 border-b border-white/5 bg-white/5">
              ...
              <span className="ml-2 text-[9px] sm:text-[10px] text-white/30 font-mono uppercase tracking-widest truncate">sergi-regany — business_logic</span>
            </div>
            <div className="p-4 sm:p-6 font-mono text-[10px] sm:text-xs md:text-sm leading-relaxed overflow-x-auto">
