    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-32 px-6 overflow-hidden dot-grid">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-7xl mx-auto py-20 px-4 md:px-0">
        ...
        <motion.h1 
          ...
          className="text-3xl sm:text-6xl md:text-[85px] font-display font-black leading-[1.1] md:leading-[1.0] tracking-tighter mb-8 md:mb-16 break-words"
        >
          <span className="text-white">Sergi —</span><br />
          <span className="text-[#00F2FE] text-glow-turq">
            AI Engineer & Full-
          </span>
          <div className="inline-block w-1.5 sm:w-2 md:w-[14px] h-[22px] sm:h-[55px] md:h-[75px] bg-[#3a3a00]/40 align-middle ml-1 md:ml-3 mb-1" /><br />
          <span className="bg-gradient-to-r from-[#5dade2] to-[#a569bd] bg-clip-text text-transparent opacity-90 text-glow-blue">
            Stack Developer
          </span>
        </motion.h1>
