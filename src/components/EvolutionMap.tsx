...
const EvolutionMap = () => {
  return (
    <section id="evolution" className="py-20 md:py-32 px-4 sm:px-6 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display uppercase tracking-tight">Evolution_MAP</h2>
        </motion.div>

        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-3 sm:left-6 top-0 bottom-0 w-[1px] bg-gradient-to-b from-brand-cyan via-brand-purple to-transparent" />

          <div className="space-y-8 md:space-y-10 pl-8 sm:pl-16">
            {milestones.map((ms, idx) => (
              ...
              >
                {/* Dot on line */}
                <div className={`absolute -left-[26px] sm:-left-[42px] top-6 w-4 h-4 rounded-full border-2 z-10 transition-all group-hover:scale-125 ${
                  ms.active
                ...
                {/* Card */}
                <div className={`glass p-5 sm:p-8 rounded-2xl border transition-all group-hover:border-brand-purple/40 ${
